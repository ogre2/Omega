...
export function FeaturesTabs() {
    return(
        <div className="features-tabs">
            ...
            slidesPerView={1}
            navigation={true}
            className="d-block d-lg-none nav nav-pills mb-5 d-flex justify-content-center navbar-nav-scroll" id="featuresTab" role="tablist">
                <SwiperSlide className="d-grid items-center">
                ...
                <SwiperSlide className="d-grid items-center">
                    <div className="nav-item mx-2" role="presentation">
            ...
            <ul className="d-none d-md-flex nav nav-pills mb-5 d-flex justify-content-center navbar-nav-scroll" id="featurestab" role="tablist">
            ...
            <div className="tab-content mt-5" id="featuresTabContent">
                <div className="tab-pane fade show active" id="featuresOne" role="tabpanel" aria-labelledby="featuresOne-tab">
                    <div className="devices">
                        <figure className="d-none d-lg-block device-mobile">
